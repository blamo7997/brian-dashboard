  ...
  return (
    <main style={{
      ...
      <section style={{
        ...
        <h1 style={{fontFamily:'Georgia,serif',color:'#ffd66d'}}>OS + Online Chatbot Continuity™</h1>
        <p style={{fontSize:'18px',lineHeight:'1.7',maxWidth:'980px'}}>The OS chatbot links to the online chatbot behind the scenes so permitted interactions can be timestamped, analyzed, personalized, and continued across environments.</p>
      </section>
    </main>
  )
}

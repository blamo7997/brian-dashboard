...
export async function getStaticProps(){
  const file=path.join(process.cwd(),"data","retired-commerce-platform-theme-health-master.json");
  let data={title:"retired-commerce-platform Theme Health Master",modules:[],rules:[],summary:""};

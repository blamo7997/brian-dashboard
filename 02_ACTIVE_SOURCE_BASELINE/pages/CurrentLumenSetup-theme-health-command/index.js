...
export async function getStaticProps() {
  const file = path.join(process.cwd(), "data", "retired-commerce-platform-theme-health-command.json");
  let data = {};
  try { data = JSON.parse(fs.readFileSync(file, "utf8")); }
  catch (e) { data = { title: "retired-commerce-platform Theme Health Command", modules: [], rules: [], summary: "Registry not found." }; }
  return { props: { data } };
}

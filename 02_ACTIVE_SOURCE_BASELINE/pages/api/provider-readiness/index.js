...
export default function handler(req, res) {
  const providers = {
    retired-commerce-platform: {
      store: exists("retired-commerce-platform_STORE_DOMAIN"),
      token: exists("retired-commerce-platform_ADMIN_ACCESS_TOKEN"),
      status: exists("retired-commerce-platform_STORE_DOMAIN") && exists("retired-commerce-platform_ADMIN_ACCESS_TOKEN") ? "ready-for-read-only-connection" : "missing-env"
    },
    openai_chatbot: {

...
if(Test-Path ".\lumen-os\windows-launcher\Start-Lumen-Research-Watcher.ps1"){
  Start-Process powershell -ArgumentList "-ExecutionPolicy Bypass -File `".\lumen-os\windows-launcher\Start-Lumen-Research-Watcher.ps1`""
}

export function normalizeBrianCoInput(rawText = "") {
  ...
  const replacements = [
    ...
    ["chabot", "chatbot"], ["sopfy", "Shopify"], ["shopfy", "Shopify"],
  ...
  return {
    ...
    intentFlags: {
      ...
      connectionSensitive: /\b(oauth|token|secret|env|backend|api|connection|vercel|shopify|supabase|payment)\b/i.test(normalized),

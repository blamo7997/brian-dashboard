...
export default function ShopifyThemeHealth(){
  const [data,setData] = useState(null);

  useEffect(()=>{
    fetch("/api/shopify-theme-health/dashboard")
      .then(r=>r.json())
      .then(setData)
      .catch(()=>setData(null));
  },[]);
    ...
    <main style={theme.page}>
      <section style={theme.shell}>
        <h1 style={{fontSize:48,color:theme.gold,marginBottom:8}}>
          Brian & Co Shopify CLI Theme Health
        </h1>

        <p style={{fontSize:18,lineHeight:1.7,maxWidth:1120}}>
          Read-only Shopify CLI theme health bridge for local theme inventory,
        ...
        {data && (
          <>
            ...
            <section style={{marginTop:24,...theme.card}}>
              ...
              <p>
                This phase inventories the local theme only. It does not push Shopify theme changes,

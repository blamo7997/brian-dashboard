export default function handler(req, res) {
  res.status(200).json({
    ...
    sales: {
      grossRevenue: { value: "Awaiting live Shopify order connection", trend: [10,18,25,38,47,59,72] },
      netRevenue: { value: "Awaiting verified accounting connection", trend: [8,14,22,31,43,52,66] },
      orders: { value: "Awaiting live Shopify order connection", trend: [12,20,28,36,48,61,70] },
